...
export default function MembersPage() {
  ...
  const handleSingleMemberSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(`Member added successfully! Invitation email sent. Added to ${singleMemberForm.selectedGroups.length} group(s).`);
    } catch (error) {
  ...
  const handleCSVUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(`Successfully processed ${result.success} members! All added to ${bulkUploadForm.selectedGroups.length} group(s).`);
...
Jane Smith,jane.smith@example.com,+0987654321,Product Manager,Innovation Inc,2020,Business Administration,New York NY`;
  ...
  const handleGroupSelection = (groupId: string, formType: 'single' | 'bulk') => {
    if (formType === 'single') {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {organization && organization.memberCount >= organization.memberLimit * 0.9 && (
        ...
        <TabsContent value="add-single" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add a single member to your organization and assign them to groups. An invitation email will be sent.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSingleMemberSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Select which groups this member should join. They will receive access to group discussions and events.
                  </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {groups.map((group) => (
                        <div
                          ...
                          onClick={() => handleGroupSelection(group.id, 'single')}
                        >
                          <div className="flex items-center space-x-3">
                ...
                <div className="flex justify-end space-x-2 pt-4 border-t">
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => setSingleMemberForm({
                      name: '', email: '', phone: '', designation: '',
                      company: '', graduationYear: '', degree: '', location: '',
                      selectedGroups: []
                    })}
                  >
                    Clear Form
        ...
        <TabsContent value="bulk-upload" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload multiple members at once using a CSV file and assign them to groups. Download the template to get started.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="bg-muted p-4 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Download the template file with the correct format and required columns
                    </p>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Select which groups all uploaded members should join. You can modify individual assignments later.
                </p>
                ...
                {bulkUploadForm.selectedGroups.length > 0 && (
                  <div className="mt-4">
                    <p className="text-sm font-medium mb-2">Selected Groups for All Members:</p>
                    <div className="flex flex-wrap gap-2">
              ...
              <form onSubmit={handleCSVUpload} className="space-y-4">
                ...
                <Button 
                  type="submit" 
                  disabled={!csvFile || loading || groups.length === 0 || bulkUploadForm.selectedGroups.length === 0} 
                  className="w-full"
                >
                  {loading ? (
                    <>
