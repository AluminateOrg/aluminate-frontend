            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                  ...
                  <Badge variant="outline" className="text-xs self-start sm:self-center">Organization Members</Badge>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                  ...
                  <Badge variant="outline" className="text-xs self-start sm:self-center">Group Members Only</Badge>
                </div>
                
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                  <div className="flex-1">
                    <h4 className="font-medium text-sm sm:text-base">Activity Status</h4>
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Show when you're online or active
                    </p>
                  </div>
                  <Badge variant="outline" className="text-xs self-start sm:self-center">Enabled</Badge>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                  ...
                  <Badge variant="default" className="text-xs self-start sm:self-center">Enabled</Badge>
                </div>
                
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                  <div className="flex-1">
                    <h4 className="font-medium text-sm sm:text-base">Group Messages</h4>
                    <p className="text-xs sm:text-sm text-muted-foreground">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                  <div className="flex-1">
                    <h4 className="font-medium text-sm sm:text-base">Mentorship Requests</h4>
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      When someone requests mentorship
                    </p>
                  </div>
                  <Badge variant="outline" className="text-xs self-start sm:self-center">Disabled</Badge>
                </div>
                
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                  <div className="flex-1">
                    <h4 className="font-medium text-sm sm:text-base">Fundraising Updates</h4>
                    <p className="text-xs sm:text-sm text-muted-foreground">
                      Updates on donation campaigns
                    </p>
                  </div>
                  <Badge variant="default" className="text-xs self-start sm:self-center">Enabled</Badge>
                </div>
